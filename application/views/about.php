		...
		<div class="container">
			...
			<div class="about-text">
				<div class="col-md-6 about-text-left">
					<img src="<?php echo  base_url('images/img11.jpg');?>" class="img-responsive" alt=""/>
				</div>
	...
	<div class="about-team">		
		<div class="container">
			...
			<div class="row team-row">
				...
				<div class="col-sm-6 col-md-3 team-grids">
					<div class="thumbnail team-thmnl">
						<img src="<?php echo  base_url('images/img13.jpg');?>" class="img-responsive zoom-img" alt="...">
						<div class="caption">
				...
				<div class="col-sm-6 col-md-3 team-grids">
					<div class="thumbnail team-thmnl">
						<img src="<?php echo  base_url('images/img14.jpg');?>" class="img-responsive zoom-img" alt="...">
						<div class="caption">
				...
				<div class="col-sm-6 col-md-3 team-grids">
					<div class="thumbnail team-thmnl">
						<img src="<?php echo  base_url('images/img15.jpg');?>" class="img-responsive zoom-img" alt="...">
						<div class="caption">
							<h4><a href="#">Jark Kohnson</a></h4>
							<p>Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary</p>						
						</div>
